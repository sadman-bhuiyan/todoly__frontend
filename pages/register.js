            ...
            <div className="bg-gray-100 dark:bg-gray-900 min-w-full min-h-full">
                ...
                <div className="w-full  mx-auto max-w-sm grid h-screen place-items-center overflow-hidden">
                    ...
                    <div className="px-6 py-8">
                        ...
                        <p className="text-3xl mt-2 text-center font-bold text-gray-500 dark:text-gray-400">Register</p>

                        <form onSubmit={handleRegister}>
                            <div className="w-full mt-4">
                                <input onChange={handleUsernameInput} name="username" className="block w-full px-8 py-4 mt-2 text-gray-700 placeholder-gray-500 bg-white border rounded-md dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-blue-300" type="text" placeholder="Username" aria-label="Username" />
                            </div>

                            <div className="w-full mt-4">
                                <input onChange={handlePasswordInput} name="password" className="block w-full px-8 py-4 mt-2 text-gray-700 placeholder-gray-500 bg-white border rounded-md dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-blue-300" type="password" placeholder="Password" aria-label="Password" />
                            </div>


                            <button className="mt-4 px-8 py-4 leading-5 text-white text-2xl transition-colors duration-200 transform bg-gray-700 rounded hover:bg-gray-600 focus:outline-none" type="submit">Sign up</button>
                        ...
                        <div className="px-4 py-2 -mx-3">
                            <div className="mx-3">
                                ...
                                <p className="text-sm text-gray-600 dark:text-gray-200">Your username is already used!</p>
                            </div>
                        </div>
                    </div>}
